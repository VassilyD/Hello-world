<div class="sidebar"> 
	<ul>
		...
		<li id="search"><?php include(TEMPLATEPATH . '/shearchform.php'); ?></li>
		...
		<li>
			...
			<ul>
				<li><a href="<?php bloginfo('rss2_url'); ?>" title="Flux RSS des articles">Flux RSS des articles</a></li> <li><a href="<?php bloginfo('comments_rss2_url'); ?>" title="Flux RSS des commentaires">Flux RSS des commentaires</a></li>
			</ul>
		</li>
		<?php endif; ?>
 	</ul> 
